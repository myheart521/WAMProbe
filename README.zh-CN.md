...
如果希望从可运行代码开始，而不是照着伪代码重新搭建，请运行已经测试过的
[自定义 Adapter Starter Kit](examples/custom_adapter/README.md)，并按照
[适配器接入指南](docs/adapters/CUSTOM_ADAPTER.md)逐步替换后端：
...
| 选择下一阶段任务 | [带依赖关系的后续路线图](docs/NEXT_STEPS.md) |
...
可以先认领带有
[`good first issue`](https://github.com/myheart521/WAMProbe/labels/good%20first%20issue) 标签的任务，
提交 [Adapter 提案](https://github.com/myheart521/WAMProbe/issues/new?template=adapter_proposal.yml)，
或使用[实验结果表单](https://github.com/myheart521/WAMProbe/issues/new?template=experiment_result.yml)。
